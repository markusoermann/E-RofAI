...
![Dignum's value-driven design ladder: values are interpreted into norms, which are in turn concretised into functionalities - a bidirectional chain that keeps the design traceable back to the values it serves (own illustration, based on Dignum 2019: p. 63).](media/responsibility-value-driven-design.png){fig-alt="Three stacked boxes labelled values, norms and functionalities, connected by double-headed arrows labelled interpretation between values and norms, and concretization between norms and functionalities." width="70%"}
