...
## Discourse ethics: how to justify norms

Deontology tells us to act on universalisable maxims, but who decides *which* maxims are valid? The German tradition of **discourse ethics**, developed by Jürgen *Habermas* and Karl-Otto *Apel* from the 1970s, offers a *procedural* answer that fits a pluralistic society particularly well. Its core idea is that the validity of a norm cannot be decreed from a single armchair; it must be redeemable in a real argument among all those affected. A norm is valid only if all who are concerned could accept it as participants in a rational discourse (Habermas's *principle of universalisation*, U), and practical questions are to be settled in such discourses rather than by force or strategic manipulation (the *discourse principle*, D). What justifies a norm is thus the quality of the *procedure*: an inclusive, coercion-free exchange of reasons in which only the "unforced force of the better argument" prevails.

For AI this school is unusually pertinent. It reframes questions of legitimacy, whose values a system encodes, as questions about *who was at the table* when those values were chosen. It underwrites the demand that affected stakeholders be included in the design of high-stakes systems, and it supplies the normative backdrop for a later unit on the public sphere and disinformation, where generative AI threatens the very conditions (authenticity, shared facts) that a functioning discourse presupposes. Where deontology asks "can this be universalised?", discourse ethics asks "could everyone affected agree to it, and were they even asked?"

::: {.flip-card}
#### Discourse ethics
A norm is valid only if all those affected could accept it as participants in a rational, coercion-free discourse; validity is a property of the *procedure* of justification, not of a single thinker's insight.
:::
...
- Habermas, J. (1990): *Moral Consciousness and Communicative Action* (translated by Christian Lenhardt & Shierry Weber Nicholsen). MIT Press, Cambridge, MA.
