...
### The first empirical signals: canaries in the coal mine

Until recently the two paradigms were argued largely a priori, with each side pointing to plausible mechanisms and to history. That is changing. Brynjolfsson, Chandar and Chen (2026) track administrative payroll records from the provider ADP covering millions of US workers, with data through June 2026, and report six descriptive facts. The first is reassuring: there is **no evidence of widespread, economy-wide job displacement**, which fits the evidence paradox we have just met. The second is not: employment of workers aged 22 to 25 in the most AI-exposed occupations stands **19 percent below where it would be had it kept pace with their less-exposed peers**, while experienced workers show no comparable gap. In plain levels, employment of 22 to 25-year-olds in the two most exposed quintiles fell by roughly 11 percent between November 2022 and June 2026, while the same age group in the three least exposed quintiles grew by about 10 percent. The third fact is that this divergence has widened steadily since the authors first documented it in August 2025, when the same measure stood at 15 percent.

Three further facts sharpen the picture. The gap operates **through reduced hiring rather than increased separations**, which means the displacement is largely invisible: it takes the form of positions that are never advertised rather than of people escorted out of the building. Second, the declines concentrate precisely where AI is used to **substitute** for human tasks; where usage is primarily **complementary**, employment is flat or rising, a distinction the authors draw from the automative and augmentative classification in the Anthropic Economic Index. Third, the adjustment shows up in employment rather than in base pay, so the labour market is clearing through headcount, not through wages. As a mechanism the authors suggest that generative AI substitutes best for **codified** knowledge, the kind formal education certifies, while complementing the **tacit**, experience-based knowledge that senior staff hold, which is exactly the knowledge that entry-level positions used to exist in order to build.

Read against the theory, three things follow. The relevant axis turns out to be the **career ladder rather than the skill ladder**: the polarization thesis predicts a hollowed-out middle, whereas the data show a narrowing entrance. The substitution and complementarity paradigms stop looking like rival prophecies and start looking like descriptions of two different *usage patterns* of the same technology, which is a strong empirical vindication of this unit's recurring claim that outcomes are designed rather than fated. And it is worth noting who signs the paper: Erik Brynjolfsson, whom we met as the face of the complementarity view, is the lead author documenting the entry-level decline, which should immunize us against reading this debate as a contest between optimists and pessimists. The authors add one further heterogeneity that belongs to the distributional question: women work in more AI-exposed occupations than men at every age, and the declines for young women are correspondingly steeper.

::: {.flip-card}
#### The narrowing entrance
Where AI has affected employment so far, it has done so by suppressing hiring rather than by causing dismissals. The effect is therefore borne almost entirely by labour market entrants and is statistically invisible in separation and unemployment figures.
:::

::: {.details}
#### Deep dive: how much weight can these numbers carry?
A great deal turns on how this study is read, so the caveats matter as much as the findings, and the authors state them plainly. These are **descriptive facts, not causal estimates**: the paper documents a correlation between occupational AI exposure and entry-level employment, and it does not establish that generative AI caused it. The sample is drawn from firms that use ADP as their payroll provider, so **selection into the sample** cannot be ruled out, and the divergence is indeed more pronounced in this panel than in national survey benchmarks such as the Current Population Survey. The estimates **attenuate when controlling for the education level of an occupation**, which may mean either that education is the real driver or that education is precisely the channel through which AI operates, and the data cannot distinguish the two. There are also **pre-trends**: more- and less-exposed occupations already diverged somewhat around the COVID-19 pandemic, before ChatGPT existed. Finally, the compensation finding rests on **base salary only**, excluding bonuses, commissions and equity, which are largest in exactly the high-income occupations under study, so adjustment through pay could be occurring unobserved.

Against these concerns the authors set four counter-observations: the divergence has kept widening long after interest rates peaked, the gap has moved below its pre-pandemic baseline rather than back toward it, the declines load specifically on automating rather than complementary usage and show a clear age gradient that interest-rate or remote-work explanations do not predict, and US government administrative data show consistent raw patterns. The honest summary is therefore neither "AI is destroying entry-level work" nor "nothing is happening", but that a signal has appeared which is consistent with the hypothesis and which is worth tracking. Treating a working paper of this kind as either proof or noise is the characteristic failure mode in this debate.
:::
...
- Brynjolfsson, E., Chandar, B. & Chen, R. (2026): *Canaries in the Coal Mine? Six Facts about the Recent Employment Effects of Artificial Intelligence*. Stanford Digital Economy Lab, August 2026 (updating the August 2025 version; ADP payroll data through June 2026). Underlying series updated monthly via the public AI Economic Indicators: <https://digitaleconomy.stanford.edu/project/indicators/canaries-dashboard/>
